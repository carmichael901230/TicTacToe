...
void interface(){
	...
	if (select[0] == 1 and select[1] == 1) 
	{	cout << "Player = X\nComputer = O" << endl;
		cout << "Difficulty: Easy" << endl << endl;
	}
	else if (select[0] == 2 and select[1] == 1)
	{	cout << "Player = X\nComputer = O" << endl; 
		cout << "Difficulty: Hard" << endl << endl;
	}
		
	else if (select[0] == 1 and select[1] == 2)
	{	cout << "Player = O\nComputer = X" << endl; 
		cout << "Difficulty: Easy" << endl << endl;
		
	}
	else if (select[0] == 2 and select[1] == 2)
	{
		cout << "Player = O\nComputer = X" << endl; 
		cout << "Difficulty: Hard" << endl << endl;
	}
...
void intro()
{
	...
	while (select[0] != 1 and select[0] != 2)
	{
		system("cls");
		cin.clear();
		cin.ignore(1, '\n');
	...
	while (select[1] != 1 and select[1] != 2)
	{
		system("cls");
		cin.clear();
		cin.ignore(1, '\n');		
...
int ai_hard()
{
	...
	if (select[1] == 2)
	{
		...
		{
			if (value[5] != '6' or value[7] != '8') return 4;
